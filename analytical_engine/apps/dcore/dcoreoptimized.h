...
#ifndef ANALYTICAL_ENGINE_APPS_DCORE_DCOREOPTIMIZED_H_
#define ANALYTICAL_ENGINE_APPS_DCORE_DCOREOPTIMIZED_H_
...
/**
 * @brief DCoreOptimizedApplication, determines the skyline coreness all the vertices,
 * which is mentioned in our paper. This can only work on both directed graph.
 *
 * This version of DCoreOptimized inherits ParallelAppBase. Messages can be sent in
...
/**
 * @brief Partial evaluation for DCoreOptimized.
 *
 * @param frag
 * @param ctx
 * @param messages
...
/**
 * @brief Incremental evaluation for DCoreOptimized.
 *
 * @param frag
 * @param ctx
 * @param messages
...
#endif  // ANALYTICAL_ENGINE_APPS_DCORE_DCORESECOND_H_