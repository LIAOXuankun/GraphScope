...
/**
 * @brief GetOutcoreness application, determines the outcoreness of each vertices
 * The definition of outcoreness is similar to incoreness
 *
 * This version of GetOutcoreness inherits ParallelAppBase. Messages can be sent in
...
/**
 * @brief Partial evaluation for GetOutcoreness.
 *
 * @param frag
 * @param ctx
 * @param messages
...
/**
 * @brief Incremental evaluation for GetOutcoreness.
 *
 * @param frag
 * @param ctx
 * @param messages
