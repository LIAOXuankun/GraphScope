...
/**
 * @brief GetIncoreness application, determines the incoreness of each vertex. Incoreness
 * is similar to k-coreness but incoreness is used in directed graph. For example, if a
 * vertex v has an incoreness of 3, it means that it is in a directed graph where each
 * vertices has at least 3 in-neighbors, but it is NOT in a directed graph where each
 * vertices has at least 4 in-neighbors.
 *
 * This version of GetIncoreness inherits ParallelAppBase. Messages can be sent in
...
/**
 * @brief Partial evaluation for GetIncoreness.
 *
 * @param frag
 * @param ctx
 * @param messages
...
/**
 * @brief Incremental evaluation for GetIncoreness.
 *
 * @param frag
 * @param ctx
 * @param messages
